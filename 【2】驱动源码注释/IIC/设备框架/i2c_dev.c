                                       ...
                                       void       *args)
{
    ...
    case RT_I2C_DEV_CTRL_10BIT:
        ...
        break;
    case RT_I2C_DEV_CTRL_TIMEOUT:/* 设置超时时间 */
        bus->timeout = *(rt_uint32_t *)args;
        break;
    case RT_I2C_DEV_CTRL_RW:/* 发送数据 */
    ...
    case RT_I2C_DEV_CTRL_CLK:
        ...
        ret = rt_i2c_control(bus, cmd, bus_clock);/* 设置时钟 */
        if (ret < 0)
        {
            return -RT_EIO;
        }
                                       ...
                                       const char               *name)
{
    ...
    device->read    = i2c_bus_device_read;/* 设备写 */
    device->write   = i2c_bus_device_write;/* 设备读*/
    device->control = i2c_bus_device_control;/* 设备控制 */
#endif
