...
#include <rtdbg.h>
/* */
#define SET_SDA(ops, val)   ops->set_sda(ops->data, val)/* 设置 SDA */
#define SET_SCL(ops, val)   ops->set_scl(ops->data, val)/* 设置 SCL */
#define GET_SDA(ops)        ops->get_sda(ops->data)/* 读取 SDA */
#define GET_SCL(ops)        ops->get_scl(ops->data)/* 读取 SCL */
/* delay 1us */
...
#define SDA_L(ops)          SET_SDA(ops, 0) /* 设置 SDA  0 */
#define SDA_H(ops)          SET_SDA(ops, 1) /* 设置 SDA  1 */
#define SCL_L(ops)          SET_SCL(ops, 0) /* 设置 SCL  0 */
